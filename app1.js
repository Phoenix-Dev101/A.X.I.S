let Commands;
const API_KEY="3520bef1685b5a7f26dae72271ee3475";
...
function ProcessCommand(UserText)
{
    ...
    for(eachCommand in Commands)
    {
        ...
        else if(UserText.includes("hey axis"))
        {
...
function getFamilyInfo()
{
    ...
    Speak("mother...father...your dog...cookie... and you...");
    Speak("you live in nigeria... which is in africa...");
...
{
    Speak("Welcome you all.. i am axis... nice to meet you...");
    Speak("I have a big list and am sure that you are one from that...");
    Speak("Ma'am... should i pack up...I think you want to talk to your friends...");
}
//Show friends list
function friendList()
{
...
function jarvisSaysHello()
{
    ...
    Speak("say what can i do for you ma'am...");
}

function greeting(){
    if(navigator.onLine)
    {
        Speak("greetings ma'am....my name is axis....which stands for Artificial Xenomorphic Intelligence System");
    }
    else{
        Speak("The system is not online...");
    }
